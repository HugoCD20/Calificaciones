...
<main>
    ...
    <form class="form-1" action="validar-registro.php" method="post">
        <label for="nombre">Nombre:</label>
        <input class="text" type="text" id="nombre" name="nombre" required>
        
        <label for="apellidos">Apellidos:</label>
        <input class="text" type="text" id="apellidos" name="apellidos" required>
        
        <label for="matricula">Matrícula:</label>
        <input class="text" type="text" id="matricula" name="matricula" required>
